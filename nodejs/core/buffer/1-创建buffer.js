...
const bh = Buffer.from('H')
console.log(bh) // <Buffer 48>

const b4 = Buffer.from('我') // 一个汉字是三个字节
console.log(b4) //<Buffer e6 88 91>

let b5 = Buffer.from([1, 2, '我']) // 如果是数组，每位必须小于 256，否则会变为00
...
const b7 = Buffer.from(b6) // 这里相当于重新复制了一份
console.log(b6 === b7, b6, b7) // false <Buffer 00 00 00> <Buffer 00 00 00>
b6[0] = 1
